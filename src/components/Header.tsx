...
function MobileNavigation(
  ...
  return (
    <Popover {...props}>
      <Popover.Button className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-xl font-medium text-zinc-800 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200">
        Menu
      ...
      <Transition.Root>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Popover.Overlay className="fixed inset-0 z-50 bg-zinc-800/40 backdrop-blur-sm dark:bg-zinc-800/80" />
        </Transition.Child>
        <Transition.Child
          as={Fragment}
          enter="duration-150 ease-out"
        ...
        >
          <Popover.Panel
            focus
            className="fixed inset-x-4 top-8 z-50 origin-top rounded-3xl bg-white p-8   dark:bg-zinc-900"
          >
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<"nav">) {
  return (
    <nav {...props}>
      <ul className="flex bg-white/90 px-3 text-xl font-medium text-zinc-800  backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200">
...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group bg-white/90 px-3 py-2  backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
...
function AvatarContainer({
  ...
  return (
    <div
      className={clsx(
        className,
        "h-10 w-10 bg-white/90 p-0.5  backdrop-blur dark:bg-zinc-800/90 "
      )}
      {...props}
    />
  );
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Container
            className="top-[var(--header-top,theme(spacing.6))] w-full h-full"
            style={{
              position:
          ...
          >
            <div className="relative flex
             bg-white/90  text-xl font-medium text-zinc-800 backdrop-blur dark:bg-zinc-800 dark:text-zinc-200 0">
              <div className="flex">
                  <AvatarContainer>
                    <Avatar />
                  </AvatarContainer>
